...
Your Salesforce Administrator just needs to do the [Getting Started](docs/getting-started/) one-time setup before [Getting Your Field Workers Started](#getting-your-field-workers-started/) with the mobile app. Then some [Further Customization](docs/further-customization/) can make it more effective for you.
