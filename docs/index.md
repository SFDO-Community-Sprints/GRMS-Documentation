...
Your Salesforce Administrator just needs to do the [Getting Started](docs/getting-started/index.md/) one-time setup before [Getting Your Field Workers Started](#getting-your-field-workers-started/index.md/) with the mobile app. Then some [Further Customization](docs/further-customization/index.md) can make it more effective for you.
